...
class _FlighDataInputState extends State<FlighDataInput> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.load) {
      ...
      riserController.text = flight.riser.toString(); //userInputs['riser'];
      bevelController.text = flight.bevel.toString();

      stairsCountController.text = flight.numberOfStep.toString();

      topCrotchLengthController.text = flight.topCrotchDistance.toString();
      bottomCrotchLengthController.text = flight.bottomCrotchDistance.toString();
      ...
      _lowerFlatPost = flight.bottomPostList;//['lowerFlatPost'];
      _rampPost = flight.rampPostList;//['rampPost'];
      _upperFlatPost = flight.topPostList;//['upperFlatPost'];
      ...
      _hasTopCrotch = flight.topCrotch;
      _hasBottomCrotch = flight.bottomCrotch;
      _hasBottomCrotchPost = flight.bottomCrotchPost;

      bottomCrotchLength = flight.bottomCrotchDistance;
      topCrotchLength = flight.topCrotchDistance;
      widget.load = false;
    } else {
      //lastInputsVal = userInputsProvider.textFormFields;
      _lowerFlatPost = flight.bottomPostList;//['lowerFlatPost'];
      _rampPost = flight.rampPostList;//['rampPost'];
      _upperFlatPost = flight.topPostList;//['
                        ...
                        Checkbox(
                            ...
                            onChanged: (value) {
                              ...
                              //userInputsProvider.textFormFields['active']
                                ...
                                flight.topPostList(_hasTopCrotch);// .updateFields('topCrotch', _hasTopCrotch);
                          ...
                          onFocusChange: (value) {
                            if (!value) {
                              if (!topFlatDistanceError) {
                                ...
                                flight.setTopCrotchDistance = double.parse(topCrotchLengthController.text);
                              } else {
                                upFlatFocus.requestFocus();
                              }
                            } else {
                        ...
                        Checkbox(
                            ...
                            onChanged: (value) {
                              _enableBtn //userInputsProvider.textFormFields['active']
                                ...
                                flight.toggleBottomCrotch(_hasBottomCrotch);
